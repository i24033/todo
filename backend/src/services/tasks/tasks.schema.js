...
export const tasksDataSchema = Type.Pick(tasksSchema, ['task', 'isComplete', 'category'], {
  $id: 'TasksData'
})
...
export const tasksQueryProperties = Type.Pick(tasksSchema, ['_id', 'task', 'isComplete', 'category'])
